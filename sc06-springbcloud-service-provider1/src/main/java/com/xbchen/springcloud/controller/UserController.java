...
public class UserController {
    ...
    public ResponseEntity<JsonResult> getUserById(@PathVariable(value = "id") Integer id) {
        logger.info("服务提供者1：UserController>>getUserById>>id:"+id);
        JsonResult r = new JsonResult();
        try {
            User user = userService.getUserById(id);
            r.setResult(user);
            r.setStatus("ok");
            logger.info("服务提供者1：UserController>>getUserList:"+ JsonUtil.obj2String(user));
        } catch (Exception e) {
        ...
        logger.info("服务提供者1：JsonResult:"+ JsonUtil.obj2String(r));
    ...
    public ResponseEntity<JsonResult> getUserList() {
        logger.info("服务提供者1：UserController>>getUserList");
        JsonResult r = new JsonResult();
        try {
